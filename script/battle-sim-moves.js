...
BattleSimulator.prototype.executeAttack = function (attacker, defender, attackerId, defenderId, selectedMove = null) {
  ...
  this.applyMoveAfterEffects(attacker, defender, move, result);
...
BattleSimulator.prototype.applyMoveAfterEffects = function (attacker, defender, move, damageResult) {
  this.applyDrainAndHealing(attacker, move, damageResult.damage);
  this.applyFlinch(defender, move);
  this.applyStatChanges(attacker, defender, move);
};

BattleSimulator.prototype.applyDrainAndHealing = function (attacker, move, damage) {
